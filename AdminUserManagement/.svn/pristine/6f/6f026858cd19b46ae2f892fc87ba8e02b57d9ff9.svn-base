...
import fusion.um.model.EO.XxfndReportParamsEoImpl;
...
public class XxfndReportParamsVoRowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        UserTables_ROVO1 {
            public Object get(XxfndReportParamsVoRowImpl obj) {
                return obj.getUserTables_ROVO1();
            }
        ...
        LookupName_ROVO1 {
            public Object get(XxfndReportParamsVoRowImpl obj) {
                return obj.getLookupName_ROVO1();
            }
        ...
        ,
        DataType_LookUp_ROVO {
            public Object get(XxfndReportParamsVoRowImpl obj) {
                return obj.getDataType_LookUp_ROVO();
            }
    ...
    public static final int USERTABLES_ROVO1 = AttributesEnum.UserTables_ROVO1.index();
    public static final int DATASECURITYCOLUMN_ROVO1 = AttributesEnum.DataSecurityColumn_ROVO1.index();
    public static final int LOOKUPNAME_ROVO1 = AttributesEnum.LookupName_ROVO1.index();
    public static final int DATATYPE_LOOKUP_ROVO = AttributesEnum.DataType_LookUp_ROVO.index();
    ...
    /**
     * Gets the view accessor <code>RowSet</code> UserTables_ROVO1.
     */
    public RowSet getUserTables_ROVO1() {
        return (RowSet)getAttributeInternal(USERTABLES_ROVO1);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LookupName_ROVO1.
     */
    public RowSet getLookupName_ROVO1() {
        return (RowSet)getAttributeInternal(LOOKUPNAME_ROVO1);
    }

    /**
     * Gets the view accessor <code>RowSet</code> DataType_LookUp_ROVO.
     */
    public RowSet getDataType_LookUp_ROVO() {
        return (RowSet)getAttributeInternal(DATATYPE_LOOKUP_ROVO);
    }
